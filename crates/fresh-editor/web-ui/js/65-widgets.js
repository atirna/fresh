...
// Everything ABOVE this line (`widgetEl` and its routing) is still live: the
// settings dialog, the keybinding editor, the aux modals and the overlay
// prompt toolbar all render through it.
